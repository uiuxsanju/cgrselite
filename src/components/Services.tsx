          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-5 sm:p-6">
                ...
                {/* CTA Button */}
                <button 
                  className={`w-full py-2.5 px-4 rounded-lg font-medium transition-all duration-300 ${hoveredCard === index ? 'bg-amber-600 text-white' : 'bg-slate-100 text-slate-700 hover:bg-slate-200'}`}
                >
                  Learn More
                </button>
              </div>
